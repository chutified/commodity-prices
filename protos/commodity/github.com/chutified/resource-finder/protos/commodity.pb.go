...
type CommodityRequest struct {
	...
	// Commodity is a name of the searching commodity.
...
func (x *CommodityRequest) GetCommodity() string {
	if x != nil {
		return x.Commodity
	}
	return ""
...
var file_commodity_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x30, 0x0a, 0x10, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x64, 0x69, 0x74, 0x79, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x64, 0x69,
	0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x64,
	0x69, 0x74, 0x79, 0x22, 0xcd, 0x01, 0x0a, 0x11, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x64, 0x69, 0x74,
	...
	,
...
var file_commodity_proto_depIdxs = []int32{
	...
	1, // 1: Commodity.GetCommodity:output_type -> CommodityResponse
...
type CommodityClient interface {
	GetCommodity(ctx context.Context, opts ...grpc.CallOption) (Commodity_GetCommodityClient, error)
}
...
func (c *commodityClient) GetCommodity(ctx context.Context, opts ...grpc.CallOption) (Commodity_GetCommodityClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Commodity_serviceDesc.Streams[0], "/Commodity/GetCommodity", opts...)
	if err != nil {
		return nil, err
	}
	x := &commodityGetCommodityClient{stream}
	return x, nil
}

type Commodity_GetCommodityClient interface {
	Send(*CommodityRequest) error
	Recv() (*CommodityResponse, error)
	grpc.ClientStream
}

type commodityGetCommodityClient struct {
	grpc.ClientStream
}

func (x *commodityGetCommodityClient) Send(m *CommodityRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *commodityGetCommodityClient) Recv() (*CommodityResponse, error) {
...
type CommodityServer interface {
	GetCommodity(Commodity_GetCommodityServer) error
}
...
func (*UnimplementedCommodityServer) GetCommodity(Commodity_GetCommodityServer) error {
	return status.Errorf(codes.Unimplemented, "method GetCommodity not implemented")
}
...
func _Commodity_GetCommodity_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CommodityServer).GetCommodity(&commodityGetCommodityServer{stream})
}

type Commodity_GetCommodityServer interface {
	Send(*CommodityResponse) error
	Recv() (*CommodityRequest, error)
	grpc.ServerStream
}

type commodityGetCommodityServer struct {
	grpc.ServerStream
}

func (x *commodityGetCommodityServer) Send(m *CommodityResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *commodityGetCommodityServer) Recv() (*CommodityRequest, error) {
